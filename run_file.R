...
reporting_process <- function(file_name="intraday_presentation.Rmd",the_date=lubridate::today()-1,audio_file_path="background_music/sample1.mp3",telegram_params=list()){
...
# 
# 
# https://github.com/acikenerji/gip_sunum/raw/main/intraday_presentation.pdf
